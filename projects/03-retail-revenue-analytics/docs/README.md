...
- [Project README](../README.md): Windows-first run path, validated local workflow, reviewer guide, troubleshooting, and optional Docker path.
...
- [Portfolio screenshots](screenshots/README.md): suggested dashboard, API, and dbt success captures.
...
- [Project README](../README.md): case study purpose, business insights, architecture direction, official run paths, and troubleshooting.
