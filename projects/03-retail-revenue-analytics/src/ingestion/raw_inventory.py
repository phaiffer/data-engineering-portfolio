...
DATASET_FOLDER_NAME = "olist_brazilian_ecommerce"
SUPPORTED_DATA_EXTENSIONS = frozenset({".csv"})


def get_project_root() -> Path:
    """Return the root directory of the retail revenue analytics project."""
    return Path(__file__).resolve().parents[2]


def get_raw_data_dir() -> Path:
    """Return the local raw Bronze directory for the Kaggle Olist dataset."""
