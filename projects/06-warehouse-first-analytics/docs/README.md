...
| Document | Contents |
|---|---|
| [source.md](source.md) | Source dataset, table inspection, grains, caveats |
| [modeling.md](modeling.md) | Staging / intermediate / marts layer design rationale |
| [marts.md](marts.md) | Each mart: grain, columns, intended use |
