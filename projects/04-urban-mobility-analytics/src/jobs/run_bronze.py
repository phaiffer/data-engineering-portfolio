...
def parse_args() -> argparse.Namespace:
    """Parse CLI arguments for the Bronze job."""
    parser = argparse.ArgumentParser(description="Build Bronze metadata for selected months.")
    ...
    parser.add_argument(
        "--force",
        action="store_true",
        help="Rebuild Bronze metadata for selected months.",
    )
    return parser.parse_args()


def main() -> None:
    """Execute the Bronze metadata job."""
    args = parse_args()
